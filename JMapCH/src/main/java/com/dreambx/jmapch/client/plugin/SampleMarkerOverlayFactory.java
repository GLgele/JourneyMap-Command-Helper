...
class SampleMarkerOverlayFactory
{
    ...
    static List<MarkerOverlay> create(IClientAPI jmAPI, BlockPos center, int quantity, int maxDistance)
    {
        ...
        ResourceLocation sprites = new ResourceLocation("jmapch:images/sprites.png");
        ...
        for (int i = 0; i < quantity; i++)
        {
            ...
            // Build the overlay
            MarkerOverlay markerOverlay = new MarkerOverlay(JmapCH.MODID, "sampleMarker" + i, pos, icon);
            ...
            {
                JmapCH.LOGGER.error("Can't add marker overlay", e);
            }
